...
export class LinkComponent {
  ...
  position() {
    ...
    const inputNodeBbox = Graphics.getNodeBbox(inputNode.position);
    const outputNodeBbox = Graphics.getNodeBbox(outputNode.position);
    ...
    this._position.input = Graphics.getPinCenter( Graphics.getPinPosition(inputNode, input.type, input.position), input.absoluteCenter )
    this._position.output = Graphics.getPinCenter( Graphics.getPinPosition(outputNode, output.type, output.position), output.absoluteCenter )
