...
export const CANT_INSTALL_ARCHITECTURE = 'CANT_INSTALL_ARCHITECTURE';
...
export const BOARD_NOT_SUPPORTED = 'BOARD_NOT_SUPPORTED';
export const CANT_GET_UPLOAD_CONFIG = 'CANT_GET_UPLOAD_CONFIG';
export const CLOUD_NETWORK_ERROR = 'CLOUD_NETWORK_ERROR';

export const DEVICE_NOT_FOUND_FOR_DEBUG = 'DEVICE_NOT_FOUND_FOR_DEBUG';
