...
export const noVariadicMarkers = patchPath => `Patch "${patchPath}" has no variadic markers.`;

export const tooManyVariadicMarkers = patchPath => `Patch "${patchPath}" has more than one variadic-* marker`;
