  ...
  (nodes, links) =>
    R.compose(
      ...
      R.map((link) => {
        ...
        const inputPinKeyHasDeadType = (
          nodes[inputNodeId].pins[inputPinKey].type === XP.PIN_TYPE.DEAD
        );
        const outputPinKeyHasDeadType = (
          nodes[outputNodeId].pins[outputPinKey].type === XP.PIN_TYPE.DEAD
        );
