...
export const PROJECT_SET_API_KEY = 'PROJECT_SET_API_KEY';
...
export const NODE_PROPERTY_UPDATED = 'NODE_PROPERTY_UPDATED';
export const NODE_CHANGE_ARITY_LEVEL = 'NODE_CHANGE_ARITY_LEVEL';
export const NODE_CHANGE_SPECIALIZATION = 'NODE_CHANGE_SPECIALIZATION';
export const NODE_RESIZE = 'NODE_RESIZE';
...
export const LINKS_SPLIT_TO_BUSES = 'LINKS_SPLIT_TO_BUSES';

export const ADD_BUS_NODE = 'ADD_BUS_NODE';
export const ADD_TERMINAL_NODE = 'ADD_TERMINAL_NODE';
...
export const PATCH_CLONE = 'PATCH_CLONE';
export const PATCH_DESCRIPTION_UPDATE = 'PATCH_DESCRIPTION_UPDATE';
export const PATCH_MANAGED_ATTACHMENT_UPDATE =
  'PATCH_MANAGED_ATTACHMENT_UPDATE';
